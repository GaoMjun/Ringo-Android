...
public final class GimbalMobileBLEProtocol {
    ...
    public final static byte[] REMOTECOMMAND_SWITCH = {(byte) 0x13};
    ...
    public final static byte[] COMMANDBACK_SWITCH_OK = REMOTECOMMAND_SWITCH;
    public final static byte[] COMMANDBACK_SWITCH_ERR = {(byte) (REMOTECOMMAND_SWITCH[0] | (byte) 0x80)};
